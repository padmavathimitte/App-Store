...
class AppStore extends Component {
  ...
  getActiveTabId = searchedApps => {
    const {activeTabId} = this.state
    const filteredApps = searchedApps.filter(
      eachSearched => eachSearched.category === activeTabId,
    )
    return filteredApps
  }
  ...
  getSearchResults = () => {
    ...
    const searchedResults = appsList.filter(eachApp =>
  ...
  render() {
    ...
    const filteredApps = this.getActiveTabId(searchedResults)
